...
import { ArrowDown, Smartphone, Star, Users } from 'lucide-react'
...
function SocialProof() {
  ...
  const stats = [
    {
      icon: Star,
      value: translations.socialProof.rating,
      label: translations.socialProof.appStore,
      highlight: true,
    },
    {
      icon: Smartphone,
      value: translations.socialProof.moments,
      label: translations.socialProof.momentsLabel,
    },
    {
      icon: Users,
      value: translations.socialProof.madeFor,
      label: translations.socialProof.families,
    },
  ]
  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10">
      {stats.map((stat, index) => (
        ...
        >
          <stat.icon
            className={`h-5 w-5 ${stat.highlight ? 'fill-sandy-clay text-sandy-clay' : 'text-wine-plum'}`}
          />
    ...
    <section className="relative min-h-screen overflow-hidden bg-linen">
      ...
      <div className="relative mx-auto max-w-7xl px-6 pt-36 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="font-serif text-[3.25rem] leading-[1.1] tracking-tight text-mauve-bark md:text-[4rem] lg:text-[4.5rem]">
            {translations.hero.headline}{' '}
          </h1>

          <h1 className="mb-7 font-serif text-[3.25rem] leading-[1.1] tracking-tight md:text-[4rem] lg:text-[4.5rem] text-wine-plum">
            {translations.hero.headlineHighlight}
          </h1>
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-5">
            ...
            >
              ...
              >
                {translations.hero.downloadFree}
                <motion.span
            ...
            >
              ...
              >
                {translations.hero.seeHowItWorks}
                <motion.span
                  className="ml-2 inline-flex"
                  animate={{ y: [0, 3, 0] }}
                  transition={{ repeat: Infinity, duration: 1.5, ease: 'easeInOut' }}
