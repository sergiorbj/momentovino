    ...
    <View style={styles.container}>
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.center}>
          <Text style={styles.title}>Atlas (placeholder)</Text>
          <TouchableOpacity style={styles.btn} onPress={() => router.push('/onboarding/account')}>
            <Text style={styles.btnText}>Save my journal</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    </View>
