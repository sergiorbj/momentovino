    ...
    <View style={styles.container}>
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.center}>
          <Text style={styles.title}>Demo (placeholder)</Text>
          <TouchableOpacity style={styles.btn} onPress={() => router.push('/onboarding/atlas')}>
            <Text style={styles.btnText}>Build my atlas</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    </View>
